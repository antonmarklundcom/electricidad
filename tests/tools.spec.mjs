...
check((await page.getAttribute("#solar-result [data-share]", "href")).startsWith("https://wa.me/?text="), "solar: share link set");
await page.click('label[for="solar-r8"]');
await page.click("#solar-form button[type=submit]");
check(/kWh/.test(await page.textContent("#solar-baterias")), "solar: battery size " + await page.textContent("#solar-baterias"));
